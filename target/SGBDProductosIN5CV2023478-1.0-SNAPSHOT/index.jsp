...
<html>
    ...
    <body>
        ...
        <div class="container d-flex justify-content-center mt-5">
            <img src="./assets/image/MercadoProyecto.png" class="w-75 border border-3 border-black border-opcacity-50 rounded">
        </div>    
        <div class="container d-flex justify-content-center">
            <h1 class="display-5 text-center"> Sistema de gestion de productos</h1>
        </div>
