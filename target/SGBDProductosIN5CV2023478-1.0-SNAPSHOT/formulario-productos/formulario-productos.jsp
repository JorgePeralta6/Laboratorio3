...
<html>
    ...
    <body>
        ...
        <div class="container mt-5 w-50">
            <form action="/SGBDProductosIN5CV2023478/producto-servlet" method="post" enctype="multipart/form-data">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control"o id="nombreProducto" name="nombreProducto" placeholder="">
                    <label for="nombreProducto">Nombre del Producto</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control"o id="marcaProducto" name="marcaProducto" placeholder="">
